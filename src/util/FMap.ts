export class FMap<K, V> implements Map<K, V> {
    ...
    // @ts-ignore
    forEach<U>(callbackfn: (this: U, key: K, value: V, map: FMap<K, V>) => void, thisArg?: U) {
        [ ...this ].forEach(([ k, v ]) => {
...
export class FSet<V> implements Set<V> {
    ...
    // @ts-ignore
    forEach<U>(callbackfn: (this: U, key: V, value: V, set: FSet<V>) => void, thisArg?: U) {
...
export class SMap<K, V> extends FMap<K, V> {
    constructor(entries: Iterable<[ K, V ]> = []) {
        super(i => typeof i === 'object' && i !== null ? i.toString() : i, entries);
    }
}
